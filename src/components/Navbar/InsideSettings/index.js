import { Text, Header, Card, CardHeader, Flex, CardBody, AddIcon, Grid, SearchIcon, Segment, Input, Button, CallVideoIcon, FlexItem } from '@fluentui/react-northstar'
            ...
            <Flex.Item >
                <Flex column gap="gap.small" vAlign="center">
                    <Flex column >
                        ...
                        <Text as="pre" content="The Mega Menu can be configured here" />
                    </Flex>
